...
function IndoensiaParticipants() {
  ...
  const generatePaymentLink = async () => {
    if (
      selectedCategory !== "IYEO Online Competition" &&
      selectedCategory !== "IYEO Offline Competition" 
    ) {
      alert(
  ...
  useEffect(() => {
    if (selectedCategory === "IYEO Online Competition") {
      setPrice("300000");
    } else if (selectedCategory === "IYEO Offline Competition") {
      setPrice("1150000");
    } else {
      setPrice("");
    }
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br></br>
            <h4>
              HALLO PESERTA IYEO 2024, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="IYEO Online Competition">
                      Kompetisi Online
                    </option>
                    <option value="IYEO Offline Competition">
                      Kompetisi Offline
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi IYEO 2024
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
                  ...
                  >
                    ...
                    <option value="IYEO Instagram">IYEO Instagram</option>
                    ...
                    <option value="IYEO Website">IYEO Website</option>
                    <option value="IYSA Email">IYSA Email</option>
                    <option value="IYEO Email">IYEO Email</option>
