...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbw8_Fiw3oxgtKZrBQTLTyRKcoXorMbtAi-c-VIJj6DqMHoyznPFS9_Zm_JuhwxDR88/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO IYEO 2024 PARTICIPANTS, Please consider the following
            ...
            <form name="regist-form">
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="SUPERVISOR_WHATSAPP_NUMBER" class="form-label">
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    IYEO 2024 Competition Information Resources
                  </label>
                  <select
                    type="text"
